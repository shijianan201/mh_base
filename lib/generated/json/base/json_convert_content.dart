...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<CommonHeadersEntity>[] is M) {
      return data.map<CommonHeadersEntity>((Map<String, dynamic> e) =>
          CommonHeadersEntity.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (CommonHeadersEntity).toString(): CommonHeadersEntity.fromJson,
  };
